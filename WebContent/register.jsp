<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="cn.ssdut.omega.util.*" %>
                    ...
                    <div class="wpl pos cl">
                        <div class="log-row-cx cl">
                            <div class="login_center">
                                 <form id="LoginForm" action="registerUser" method="post">
                                        ...
                                        <label class="login-icon pos">
                                            ...
                                            <input  type="password" name="password" style="position: absolute; top: 10px;"  class="log-input login-pwd mls" placeholder="please input you password">
                                        </label>
                                                                                <label class="login-icon pos">
                                            <img width="17px" style="position: absolute; top: 10px;" src="./images/login/password.png">
                                            <input  type="text" name="mail" style="position: absolute; top: 10px;" class="log-input login-pwd mls" placeholder="please input you mail">
                                        </label>
                                        <button type="submit" class="lang-btn lang-btn-huge mtw lang-btn-fixed-Large"  style="margin-top: 30px !important;">
                                            <span class="lang-btn-content">Register User</span>
                                        </button>
                                        <button id="login-button"  formaction="registerManager" class="lang-btn lang-btn-huge mtw lang-btn-fixed-Large" style="margin-top: 30px !important;">
                                            <span class="lang-btn-content">Register Manager</span>
                                        </button>
                                </form>
                               <p class="login-msg"><span>已有账号？<a href="login.jsp">立即登录</a></span></p>
                            </div>
                        </div>
                    </div>
                </div>
