...
--%>
<%@page import="cn.ssdut.omega.management.RemarkManagement_Omega"%>
...
<%
   ...
   RemarkManagement_Omega manage = new RemarkManagement_Omega();
   List<Remark_Omega> remarks = manage.findRemarkByProductId(id);
   if(remarks!=null&&remarks.size()>0)
	   for(Remark_Omega remark:remarks){
		   %>
        ...
        <div class="cart-sec simpleCart_shelfItem">
            ...
            <div class="cart-item cyc">
                <img src="images/home-images/image-1.jpg" class="img-responsive" alt=""/>
            ...
            <div class="cart-item-info">
                ...
                <h3><a href="#">User:A***E</a><span>Evaluation:<%=remark.getContent() %></span></h3>
      
                <div class="delivery">
                    <p>Purchase details:White/xl/short/num:2</p>
                    <span>Date of purchase:<%=remark.getTime() %></span>
	...
	<%
	   ...
	   <div style="font-size:20px;margin:10px">
	      ...
	      Write your remark：<input type="text" name="content" >
	      <input style="margin-left:10px;padding-right:10px;padding-left:10px"type="submit" value="OK">
	   </form>
	   </div>
    </div>
